...
setup(
    ...
    data_files=[
        ...
        (os.path.join('share', package_name, 'urdf'), glob('mecanum_robot.urdf'))
    ],
    ...
    entry_points={
        'console_scripts': [
            ...
            'goal_publish = autonomous_tb3.scripts.goalpublish:main',  # Ensure this is correct
            'EKF = autonomous_tb3.scripts.EKF:main'
        ],
    },
)
